...
module Jekyll
  ...
  class FlickrPhotosetTag < Liquid::Tag
    ...
    def render(context)
      @photoset       = lookup(context, @params[0])
      ...
      if photos.count == 1
        ...
        output += "    <ul class=\"clearing-thumbs thumbs\" data-clearing>\n"

        photos.each do |photo|
          if photo['urlVideo'] != ''
            output += "      <li>\n"
            output += "      <a href=\"#{photo['urlFlickr']}\" class=\"venobox\" data-gall=\"myGallery\">\n"
            output += "      <img src=\"#{photo['urlFlickr']}\"> \n"
            output += "    </a>"
            ...
            output += "      <li><a class=\"venobox vbox-item th\" href=\"#{photo['urlOpened']}\" data-gall=\"myGallery\"><img src=\"#{photo['urlThumb']}\" alt=\"#{photo['title']}\" title=\"#{photo['title']}\"></a></li>\n"
          end
        end
